// Generated from the Laravel app's config/quran.php - do not edit by hand.
// The 114 surahs in Mushaf order with their standard ayah counts. Used to populate
// the surah/ayah pickers and to validate submitted ayah ranges server-side.
...
export const SURAH_NUMBER_BY_NAME = new Map(SURAHS.map((s) => [s.name, s.number]));
